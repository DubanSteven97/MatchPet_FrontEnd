			...
			<div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
				<div class="m-l-25 m-r--38 m-lr-0-xl">
					<div class="wrap-table-shopping-cart">
						<table class="table-shopping-cart" id="tblCarrito">
							<tr class="table_head">
					...
					<div class="flex-w flex-t p-t-27 p-b-33">
						...
						<div class="size-209 p-t-1">
							<span class="mtext-110 cl2" id="totalCompra">
								<?= FormatMoney($subTotal + COSTOENVIO); ?>
							</span>
						</div>
					</div>

					<a href="<?= BaseUrl(); ?>/carrito/procesarPago" id="btnComprar" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">
						Procesar Pago
					</a>
				</div>
			</div>
...
<br>
<div class="container">
	<p>No hay productos en el carrito <a href="<?=BaseUrl();?>/tienda"> Ver productos</a></p>
</div>
<br>
<?php 
}
