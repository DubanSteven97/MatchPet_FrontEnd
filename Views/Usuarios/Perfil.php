        ...
        <div class="col-md-3">
          <div class="tile p-0">
            <ul class="nav flex-column nav-tabs user-tabs">
              <li class="nav-item"><a class="nav-link active" href="#user-dataPersonal" data-toggle="tab">Datos Personales</a></li>
              <li class="nav-item"><a class="nav-link" href="#user-dataFiscal" data-toggle="tab">Datos Fiscales</a></li>
              <li class="nav-item"><a class="nav-link" href="#user-dataPagos" data-toggle="tab">Pagos</a></li>
            </ul>
          </div>
        </div>
        <div class="col-md-9">
          <div class="tab-content">
            <div class="tab-pane active" id="user-dataPersonal">
                ...
                <table class="table table-bordered">
		            <tbody>
		              <tr>
		                ...
		                <td id="celIdentificacion"><?= $_SESSION['userData']['numero_identificacion'];?></td>
		              </tr>
		              <tr>
		                <td>Nombres:</td>
		                <td id="celNombres"><?= $_SESSION['userData']['nombres']; ?></td>
		              </tr>
		              <tr>
		                <td>Apellidos:</td>
		                <td id="celApellidos"><?= $_SESSION['userData']['apellidos']; ?></td>
		              </tr>
		              <tr>
		                <td>Teléfono:</td>
		              ...
		              <tr>
		                <td>Email (Usuario):</td>
		                <td id="celEmail"><?= $_SESSION['userData']['email']; ?></td>
		              </tr>
		            </tbody>
		          </table>
              </div>
            </div>
            <div class="tab-pane fade" id="user-dataFiscal">
            ...
            <div class="tab-pane fade" id="user-dataPagos">
              <div class="tile user-settings">
              	<p>Pagos</p>
              </div>
            </div>
