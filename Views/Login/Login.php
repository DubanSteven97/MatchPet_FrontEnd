...
<html lang="es">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Juan Sebastián Benavides">
    <meta name="theme-color" content="#009688">
    <link rel="shortcur icon" href="<?=media();?>/images/favicon.ico">
    <!-- Main CSS-->
  ...
  <body>
    ...
    <section class="login-content">
      ...
      <div class="login-box">
        ...
        <form class="login-form" action="" id="formLogin" nombre="formLogin">
          ...
          <div type="submit" class="form-group btn-container">
            <button class="btn btn-primary btn-block"><i class="fas fa-sign-in-alt"></i> INICIAR SESIÓN</button>
          </div>
        </form>
        <form class="forget-form" action="" name="formRecetPass" id="formRecetPass">
