            ...
            <p class="text-primary">Todos los campos con asterisco (<span class="required">*</span>) son obligatorios.</p>
           	<div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" id="txtCodigo" name="txtCodigo" type="text" placeholder="Código de barra"  onkeypress="return ControlTag(event);"  required>
                    <br>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input class="form-control" id="txtStock" name="txtStock" type="text" onkeypress="return ControlTag(event);"  required>
                    </div>
                  </div>
                  <div class="row">
                    <div class="form-group col-md-6">
                   ...
                   <div class="form-group col-md-6">
                      <button class="btn btn-danger  btn-lg btn-block" type="button" data-dismiss="modal"><i class="fa fa-fw fa-lg fa-times-circle"></i><span id="btnText">Cerrar</span></button>
                   </div>
                  </div>
