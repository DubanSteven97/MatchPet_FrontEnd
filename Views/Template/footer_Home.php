		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-lg-4 p-b-50">
					...
					<div class="p-t-27">
						<a href="https://www.facebook.com/Jsebastianb10" target="_blanck" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
							<i class="fa fa-facebook"></i>
						</a>

						<a href="https://www.instagram.com/jsebastianbe/?hl=es-la" target="_blanck" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
							<i class="fa fa-instagram"></i>
						</a>

						<a href="https://twitter.com/JuSeBeMa" target="_blanck" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
							<i class="fa fa-twitter"></i>
						</a>

						<a href="https://wa.me/57320997016" target="_blanck" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
				...
				<div class="col-sm-6 col-lg-4 p-b-50">
					...
					<form id="frmSuscripcion" name="frmSuscripcion">
						<div class="wrap-input1 w-full p-b-4">
							<input class="input1 bg-none plh1 stext-107 cl7" type="text" name="nombreSuscripcion" placeholder="Nombre completo" id="nombreSuscripcion" required>
							<div class="focus-input1 trans-04"></div>
						</div><br>
						<div class="wrap-input1 w-full p-b-4">
							<input class="input1 bg-none plh1 stext-107 cl7" type="email" name="emailSuscripcion" placeholder="email@example.com" id="emailSuscripcion" required>
							<div class="focus-input1 trans-04"></div>
						</div>
