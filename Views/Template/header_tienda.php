	...
	<!-- Header desktop -->
		...
		?>
				<nav class="limiter-menu-desktop container">
					...
					<a href="<?= BaseUrl(); ?>" class="logo">
						<img src="<?= media(); ?>/images/logo-01.png" alt="Tienda Virtual">
					</a>
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li>
								<a href="<?= BaseUrl(); ?>/tienda">Tienda</a>
							</li>

							<li>
								<a href="<?= BaseUrl(); ?>/carrito">Carrito</a>
							</li>
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart" data-notify="<?= $cantCarrito; ?>" id="cantCarrito">
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="<?=BaseUrl();?>"><img src="<?= media(); ?>/tienda/images/icons/logo-01.png" alt="IMG-LOGO"></a>
			</div>
			...
			<div class="wrap-icon-header flex-w flex-r-m m-r-15">
				...
				<?php if($data['page_name'] != "carrito"  && $data['page_name'] != "procesarpago"){?>
				<div class="icon-header-item cl2 hov-cl1 trans-04 p-r-11 p-l-10 icon-header-noti js-show-cart cantCarrito" data-notify="<?= $cantCarrito; ?>" id="cantCarritoM">
					<i class="zmdi zmdi-shopping-cart"></i>
				</div>
				<?php } ?>
			</div>
