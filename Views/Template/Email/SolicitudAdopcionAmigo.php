		...
		<tbody>
			...
			<tr>
				<td>
					...
					<p>Gracias por iniciar el proceso de adopción.</p>
					<p>Un miembro del equipo se pondrá en contacto para gestionar el proceso de adopción.</p>
					<p>Accede a tu cuenta con tus credenciales para validar el estado del proceso.</p>
					<a href="<?= BASE_URL; ?>" targer="_blank" class="x_button_link x_link_blue"></a>
