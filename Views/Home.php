				...
				<div class="container h-full">
					<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
						...
						<div class="layer-slick1 animated visible-false" data-appear="zoomIn" data-delay="1600">
							<a href="<?= BaseUrl().'/tienda/categoria/'.$arrSlider[$i]['idcategoria'].'/'.$ruta;?>" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
								Ir a la tienda
							</a>
						</div>
					</div>
		...
		?>
			<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
				...
				<div class="block1 wrap-pic-w">
					...
					<a href="<?= BaseUrl().'/tienda/categoria/'.$arrSlider[$i]['idcategoria'].'/'.$ruta;?>" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
